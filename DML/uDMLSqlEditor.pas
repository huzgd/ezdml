...
procedure TfrmDmlSqlEditor.sbtnSqlPrevClick(Sender: TObject);
begin
  CheckLoadOldSql;
...
procedure TfrmDmlSqlEditor.sbtnSqlNextClick(Sender: TObject);
begin
  if FHisIndex <> -1 then
    SetHistorySql(FHisIndex - 1)
  else
...
procedure TfrmDmlSqlEditor.LabelSqlMouseDown(Sender: TObject;
...
procedure TfrmDmlSqlEditor.sbtnClearAllClick(Sender: TObject);
var
  sql: string;
begin
...
procedure TfrmDmlSqlEditor.sbtnConnectDbClick(Sender: TObject);
var
  I: integer;
begin
  I := GetLastCtDbConn;
