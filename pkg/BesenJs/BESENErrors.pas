...
procedure BESENThrowNotDefinedForNilObj(const ARef:TBESENValue);  //added by huz 20191014
...
procedure BESENThrowNotDefinedForNilObj(const ARef:TBESENValue);
begin     //added by huz 20191014
 BESENThrowReferenceError('Can not access property "'+ARef.Str+'" of a null object');
end;
