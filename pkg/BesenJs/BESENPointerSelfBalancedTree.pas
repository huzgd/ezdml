...
var n:PBESENPointerSelfBalancedTreeNode;
    rn:PBESENPointerSelfBalancedTreeNode; //added by huz 20220221
begin
 rn:=nil; //added by huz 20220221
 try
  n:=RootNode^.Left;
  while assigned(n) do begin
   if Key=n^.Key then begin
    ...
    if n=rn then //added by huz 20220221: prevent dead loop
      break;
    rn := n; //added by huz 20220221
