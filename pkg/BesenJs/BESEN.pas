...
type TBESEN=class;
     ...
     TBESEN=class
      public
       ...
       DmlBsObjMap: TBESENHashMap; //added by huz 20191002
...
begin
 ...
 DmlBsObjMap:= TBESENHashMap.Create; //added by huz 20191002
...
begin
 ...
 DmlBsObjMap.Free; //added by huz 20191002
...
begin
 ...
 try
  ...
  if (Compatibility and COMPAT_JS)<>0 then begin
   ...
   result.OverwriteData('name',BESENStringValue(Name),[bopaWRITABLE,bopaCONFIGURABLE]);//changed by huz 20211225: name writable
  end;
